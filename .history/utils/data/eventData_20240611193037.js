...
export const joinEvent = (eventId) => {
  ...
  const url = `http://your-api-url/events/${eventId}/join/`; // Adjust the URL as per your API endpoint
...
export const leaveEvent = (eventId) => {
  const uid = localStorage.getItem('uid'); // Assuming UID is stored in local storage
  const url = `http://your-api-url/events/${eventId}/leave/`; // Adjust the URL as per your API endpoint
